...
export function serialize(
  ...
  return {
    ...
    energy: { ...energy },
    economy: { ...economy },
    collection: [...collection.unlockedIds],
    collectionUnclaimed: [...collection.unclaimedIds],
    orders,
    lastOnline: Date.now(),
    ...
    completedRareIds: subs?.shardState ? [...subs.shardState.completedRareIds] : undefined,
